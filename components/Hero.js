      ...
      <div className="grid grid-cols-1 grid-rows-3 gap-8 py-12">
        <div className="my-2 grid items-start gap-8">
          <div className="group relative">
            ...
            <a target="_blank" rel="noreferrer" href="https://discord.gg/9c6cWVwdEJ">
        ...
        <div className="my-2 grid items-start gap-8">
          <div className="group relative">
            ...
            <a target="_blank" rel="noreferrer" href="https://github.com/thaza-kun/">
              <a className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black">
                <span className="flex items-center space-x-5">
                  <svg
        ...
        <div className="my-2 grid items-start gap-8">
          <div className="group relative">
            ...
            <a target="_blank" rel="noreferrer" href="https://ko-fi.com/thaza_kun">
              <a className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black">
                <span className="flex items-center space-x-5">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
